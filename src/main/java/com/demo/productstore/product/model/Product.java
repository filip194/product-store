...
public record Product(
    ...
    public Product(ProductCode code, String name, String description, Price priceEur, Price priceUsd, boolean available) {
        this(null, UUID.randomUUID(), code, name, description, priceEur, priceUsd, available);
    }
